    ...
    window.app = {
        ...
        spritely: {
            ...
            init: function() {
              ...
              if ($('#clouds').length && $('#hill1').length && $('#hill2').length){
                $('#hill1, #hill2, #clouds').spRelSpeed(8);
              }
              $('#playpause').click(function() { 
                $('#bird, #bird2').spRandom(); 
                $('#hill1, #hill2, #clouds').spToggle();
              });
            ...
            sliderChange: function(val) {
                ...
                if (sliderSpeed < 0) {
                  ...
                  if ($('#bird').length && $('#bird2').length){
                    $('#bird, #bird2').spState(2);
                  }
                  $('#hill1').spChangeDir('right');
                  if ($('#hill2').length && $('#clouds').length){
                    $('#hill2, #clouds').spChangeDir('right');
                  }
                } else {
                  if ($('#bird').length && $('#bird2').length){
                    $('#bird, #bird2').spState(1);
                  }
                  $('#hill1').spChangeDir('left');
                  if ($('#hill2').length && $('#clouds').length){
                    $('#hill2, #clouds').spChangeDir('left');
                  }
                }
                $('#hill1').spRelSpeed(sliderSpeed);
                if ($('#hill2').length && $('#clouds').length){
                  $('#hill2, #clouds').spRelSpeed(sliderSpeed);
                }
